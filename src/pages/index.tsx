...
export default function Home() {
  return (
    <main className="bg-gray-950">
      ...
      <div className="flex flex-col py-6 px-6 gap-16">
        {/* Header */}
        ...
        <div className="grid responsive-grid gap-6">
          <div className="flex flex-col gap-6 2xl:col-start-2">
            <div className="flex flex-col gap-2">
              <p className="text-gray-50 text-xl">I design digital products.</p>
            ...
            <div className="border rounded-full border-gray-900 px-4 py-2 text-sm text-gray-500 inline-block">
        ...
        <div className="grid responsive-grid">
          <div className="flex flex-col gap-16 2xl:col-start-2">
            <div className="flex flex-col gap-2">
