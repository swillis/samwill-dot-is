    ...
    <main className="dark:bg-gray-950 bg-gray-50">
      ...
      <div className="flex flex-col py-6 px-6 gap-32">
        ...
        <div className="flex flex-row justify-between">
          ...
          {/* <button className="h-10 w-10 rounded-full border border-gray-200 flex justify-center items-center">
            <Icon
              name="sun"
              className="dark:fill-gray-500 fill-gray-600 dark:group-hover:fill-white group-hover:fill-gray-900"
              size={20}
        ...
        {/* CV */}
        <div className="grid responsive-grid xl:grid-cols-3">
          <div className="flex flex-col gap-16 xl:col-start-2">
            {/* Projects */}
            <SectionOne>
              <div className="flex flex-col gap-2">
                ...
                <Link
                  href="https://alba.art"
                  target="_blank"
                  className="flex flex-row gap-4 rounded-lg grow align-baseline group dark:bg-gray-950 p-3 hover:shadow-test z-10 hover:-z-0 transition-all ease-in-out duration-300"
                >
                  <div className="p-1">
                    {/* <Image
                      src="/logos/alba.svg"
                  ...
                  <div className="border-b border-solid dark:border-gray-900 flex grow mb-1 dark:group-hover:border-gray-300 transition-all ease-in-out duration-300"></div>
